Overview
The main goal of this project was to learn how to integrate multiple APIs on the server side, process the received data, and display it clearly on the frontend in a simple, user-friendly way.
The project is divided into server and client parts for better organization: all API logic is handled in **core.js**, while **server.js** runs the Express server and sends processed data to the frontend.
The **public** folder contains static files (HTML, CSS, JS) that display this data to the user.
...
Countrylayer API:
https://manage.countrylayer.com/signup/free
...
The user interface has a clean pastel design, soft color tones, and organized cards for each section:
Random User Information
Country Information
Exchange Rates
News Headlines
All parts are visually separated and responsive, making the application easy to read and use.
Conclusion
In conclusion, the project successfully integrates four different APIs into one functional application.
